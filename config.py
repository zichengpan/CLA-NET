...
class LoadConfig(object):
    def __init__(self, args, version):
        ...
        if args.dataset == 'CUB':
            ...
            self.rawdata_root = './data/CUB/images'
            self.anno_root = './data/CUB/anno'
            self.numcls = 200
        elif args.dataset == 'disease':
            self.dataset = args.dataset
            self.rawdata_root = './data/plant_disease/images'
            self.anno_root = './data/plant_disease/anno'
            self.numcls = 4
        elif args.dataset == 'disease_ICLR':
            self.dataset = args.dataset
            self.rawdata_root = './data/plant_disease_ICLR/images'
            self.anno_root = './data/plant_disease_ICLR/anno'
            self.numcls = 3
        elif args.dataset == 'STCAR':
            self.dataset = args.dataset
            self.rawdata_root = './data/STCAR/images'
            self.anno_root = './data/STCAR/anno'
            self.numcls = 196
